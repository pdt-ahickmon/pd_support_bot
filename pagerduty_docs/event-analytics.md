...
The Event Analytics report allows you to view historical [accepted events](#accepted-events) in order to identify past trends in volume. This information can help pinpoint times of peak load, or troubleshoot greater-than-expected volumes.

For [consumption-based billing accounts](/main/docs/aiops), this is the “billable accepted events” under your pricing plan. This data can help you anticipate yearly event volumes and monitor your event consumption relative to your yearly budget.
...
Accepted events are any valid events that are sent to and processed by PagerDuty via email integration or API with a successful `2XX` response. The number of events should correlate with the number of `2XX` responses you receive from the Events API.
...
> -------------------
> 
> Event analytics reporting data begins in February 2023.
...
![A screenshot of the PagerDuty UI detailing the Event Analytics report](https://files.readme.io/31315f4-event-analytics-report.png)
...
The Event Breakdown table allows account admins to identify the sources of their event volume, broken down by routing key. This can help teams manage their events and identify integration keys and services that significantly contribute to event volume.

> 🚧 Required User Permissions
> ---------------------------
> 
> The Event Breakdown table is only available for the Account Owner and Admin users.

![A screenshot of the PagerDuty UI detailing the Event Breakdown table](https://files.readme.io/fe71ffd-Event_Volume_Detailed_Breakdown.png)
...
* + [Accepted Events](#accepted-events)
  + [View the Event Analytics Report](#view-the-event-analytics-report)
