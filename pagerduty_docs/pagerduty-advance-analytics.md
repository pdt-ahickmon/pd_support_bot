...
PagerDuty Advance Analytics is designed for teams using [PagerDuty Advance](/main/docs/pagerduty-advance) that are looking to leverage data-driven insights to streamline incident response and improve efficiency. By visualizing key metrics like Mean Time to Acknowledge (MTTA) and Mean Time to Resolve (MTTR), along with usage breakdowns and time saved through automation, PagerDuty Advance Analytics helps teams identify trends, optimize response efforts, and maximize the impact of automation. It’s an essential tool for any organization that wants to enhance operational resilience, reduce manual workloads, and harness the power of AI-driven insights to improve incident management outcomes.

> 📘 Availability
> --------------
> 
> PagerDuty Advance Analytics is available on the following pricing plans: Professional, Business, Digital Operations (legacy) and Enterprise for Incident Management. Please contact our [Sales Team](https://www.pagerduty.com/contact-us/#contact-sales) to upgrade to an account plan with this feature.

> 🚧 Required Permissions
> ----------------------
> 
> All user roles have access to PagerDuty Analytics.

View PagerDuty Advance Analytics
================================

You can view PagerDuty Advance Analytics in the PagerDuty web app by navigating to **Analytics**  **PagerDuty Advance**.

Data in the Analytics Dashboard updates once per day. It may take up to 24 hours for new data to appear. A timestamp in the page's top-right indicates the last update.

> 📘 Data Availability
> -------------------
> 
> Data for PagerDuty Advance Analytics is available starting September 16, 2024.

Key Features
============

PagerDuty Advance Analytics consists of the following sections:

| Section | Description |
| --- | --- |
| **Advance usage** | Number of incidents where teams interacted with Advance. |
| **Total Incidents using Advance** | Number of incidents where teams interacted with Advance. |
| **MTTA for Incidents using Advance** | Mean time to acknowledge where teams interacted with Advance. |
| **MTTR for Incidents using Advance** | Mean time to resolve where teams interacted with Advance. |
| **Total time saved** | Total time saved through the combined usage of Advanced Actions. |
| **Average time saved per Advance action** | [See how PagerDuty estimates time saved](https://support.pagerduty.com/main/docs/pagerduty-advance#how-many-credits-does-each-action-cost). |
| **Total credits usage breakdown by Advance action** | Total credits usage breakdown by Advance Action. [See how credits work](https://support.pagerduty.com/main/docs/pagerduty-advance#how-many-credits-does-each-action-cost). |
| **Usage breakdown by Action** | The actions table can be found [here](https://support.pagerduty.com/main/docs/pagerduty-advance#how-many-credits-does-each-action-cost). A promoted action is when the user requests an action by either typing or clicking on a button. The proactive message is when PagerDuty Advance proactively shows insights without the user requesting it. |

Filter and Search
=================

To help you find the most relevant results, the following filters are available:

* **Team**: Filter by specific teams or view all teams.
* **Escalation Policy**: Select one or more escalation policies.
* **Service**: Choose specific services to analyze.
* **Urgency**: Filter by All, High, or Low-urgency incidents.
* **Priority**: Select from All or any of your account's preconfigured incident priority levels.
* **Date Range**: Choose from preset options or select a custom date range. Custom date ranges can span up to one year.

Share the PagerDuty Advance Analytics Dashboard
===============================================

To share the PagerDuty Advance Analytics dashboard:

1. Navigate to **Analytics**  **PagerDuty Advance**.
2. Click **Share** in the top-right corner of the dashboard.
3. Click **Copy Link** to copy the dashboard's unique URL to your clipboard. You can share this link with colleagues who have access to PagerDuty Advance.

Users who visit the shared link will see the same filters applied in their dashboard view.
...
* [Table of Contents](#)
* + [View PagerDuty Advance Analytics](#view-pagerduty-advance-analytics)
  + [Key Features](#key-features)
  + [Filter and Search](#filter-and-search)
  + [Share the PagerDuty Advance Analytics Dashboard](#share-the-pagerduty-advance-analytics-dashboard)
