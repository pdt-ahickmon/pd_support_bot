...
Custom Fields defined as part of the integration will count towards the account’s limits for custom fields. For more information, please see our [Custom Fields on Incidents](/main/docs/custom-fields-on-incidents) article.
...
| Zendesk Field Type | PagerDuty Field Type |
| --- | --- |
...
The following behaviors are possible on the [Custom Field Mappings](#view-custom-field-mappings) page:
...
In order for custom field data to sync bidirectionally, you must link the PagerDuty incident to a Zendesk record. Please see our [Zendesk User Guide](/main/docs/zendesk-user-guide) for more information.
...
* + [Create Custom Field Mappings](#create-custom-field-mappings)
  ...
  + [Zendesk Fields Eligible for Mapping](#zendesk-fields-eligible-for-mapping)
  + [Post-mapping Behavior](#post-mapping-behavior)
    - [Post-mapping Behavior on the Custom Field Mappings Page](#post-mapping-behavior-on-the-custom-field-mappings-page)
