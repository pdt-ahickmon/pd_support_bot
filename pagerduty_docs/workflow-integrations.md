...
Some [Workflow Actions](/actions/docs/incident-workflow-actions-overview) use an integration type called Workflow Integrations to connect to [Incident Workflows](/main/docs/incident-workflows). Workflow Integrations support authentication using API keys and/or OAuth, and are designed for incident response teams and administrators to securely and easily connect PagerDuty with external tools. This feature simplifies automation, enhances security, and streamlines Incident Workflows, enabling faster resolutions and improved efficiency.

Workflow Integrations are supported with the following tools:

* [AWS](/actions/docs/aws)
* [Azure Functions](/actions/docs/azure)
* [Datadog](/actions/docs/datadog)
* [Jeli](/actions/docs/jeli)
* [Microsoft Entra ID (Azure AD)](/main/docs/entra-id-integration-jeli)
* [PagerDuty Runbook Automation](https://docs.rundeck.com/docs/)
* [Slack Bot Integration](/actions/docs/slack)
* [Web API](/actions/docs/web-api)

> 🚧 Required User Permissions
> ---------------------------
> 
> User with the following roles can **add, update and delete** Workflow Integration connections:
> 
> * Manager
> * Admin
> * Account Owner
...
![A screenshot of the PagerDuty web app showing how to add a Workflow Integration connection](https://files.readme.io/f0547d5-add_connection.png)
...
3. Expand the section below that corresponds to your preferred technology, and enter the requested information:
   ...
   4. **Jeli**
      ...
      | --- | --- |
      | **Connection Name** | The name to give the new connection |
      | **API Token** | Enter your [Jeli API token](/main/docs/jeli-api) |
   ...
   5. **Microsoft Entra ID (Azure AD)**
      ...
      You will be directed to [Microsoft's login page](https://login.microsoftonline.com/). Follow the on-screen prompts to complete the Workflow Integration.
   6. **PagerDuty Runbook Automation**
      ...
      | **Token** | The [API Token](https://docs.rundeck.com/docs/api/api_basics.html) that will provide authentication |
...
4. In the field **Who can edit or select the connection**, select **All admins and global managers** (default) or **All admins, global managers team managers on specific teams**. If you choose **All admins, global managers team managers on specific teams**, select one or more [Teams](/main/docs/teams) from the **Select teams** dropdown.

![A screenshot of the PagerDuty web app showing how to select Teams that should have access to the Workflow Integration](https://files.readme.io/497d27c-select_teams.png)
...
> ------------------
> 
> This setting affects which users can edit the connection or select the connection when configuring actions in an Incident Workflow. This setting does not affect who can *invoke* an Incident Workflow; that setting is administered while [creating or editing an Incident Workflow](/main/docs/incident-workflows#create-an-incident-workflow).
...
Creating a Workflow Integration will allow you to use some tool-specific Incident Workflow Actions. Please read [Incident Workflows](/main/docs/incident-workflows#actions) for more information.
...
* [Table of Contents](#)
* + [Create a Workflow Integration](#create-a-workflow-integration)
  + [Delete a Workflow Integration](#delete-a-workflow-integration)
  + [Use a Workflow Integration in Incident Workflows](#use-a-workflow-integration-in-incident-workflows)
