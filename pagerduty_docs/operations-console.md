...
![An image demonstrating the Operations Console with many triggered incidents](https://files.readme.io/aee8c94-operations_console_overview.png)
...
![An image detailing the column selector](https://files.readme.io/cff6f9e-column_selector.png)
...
At the highest level, you can show **All** incidents, or click **My teams** to display just incidents belonging to your [Teams](/main/docs/teams). You can also quickly filter by incident status: **Open**, **Acknowledged**, or **Triggered**.
...
2. Click **Add** and select from the following:
   ...
   9. [**Custom Details**](#custom-details) (Available by request)
...
![An image detailing filtering capabilities in the Operations Console](https://files.readme.io/78d1b2a-filter_and_search.png)
...
![An image detailing the various actions users can take on incidents in the Operations Console](https://files.readme.io/bf085b0-actions.png)
...
![An image detailing the UI to add a column based on custom details](https://files.readme.io/67d3a1e-opertaions_console_add_custom_details_columns.png)
...
![An image detailing columns based on custom details](https://files.readme.io/35c3881-custom_details.png)
...
![A screenshot of the PagerDuty UI indicating that incidents in the Operations Console are loading](https://files.readme.io/448b1d6-loading_incidents.png)
...
Yes, you can define custom fields as filters to narrow down results or search for specific incidents. Please read [Custom Details](#custom-details) above for more information.
...
* [Table of Contents](#)
* + [View the Operations Console](#view-the-operations-console)
  + [Configure the Operations Console](#configure-the-operations-console)
    - [Column Selector](#column-selector)
    - [Filters and Search](#filters-and-search)
    - [Actions](#actions)
    - [Custom Details](#custom-details)
  + [FAQ](#faq)
    - [How can I troubleshoot connection issues if the Operations Console does not load?](#how-can-i-troubleshoot-connection-issues-if-the-operations-console-does-not-load)
    - [Can I add event custom fields from the alert payload to the Operations Console?](#can-i-add-event-custom-fields-from-the-alert-payload-to-the-operations-console)
    - [How many event custom fields can I display in the Operations Console?](#how-many-event-custom-fields-can-i-display-in-the-operations-console)
