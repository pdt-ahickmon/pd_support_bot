...
> --------------
> 
> This feature is available with the Business, Enterprise for Incident Management and Digital Operations (Legacy) pricing plans. Please [contact Sales](https://www.pagerduty.com/contact-us/#contact-sales) to upgrade to a plan with this feature.

![](https://files.readme.io/903d903-custom-fields-overview.png "custom-fields-overview.png")
...
1. Navigate to **Incidents**  **Incident Types** from the top navigation bar.
2. Click **New Field**.
...
4. Next, select the [**Field Type**](#field-types).
5. *Optional*: You may optionally set a default value that will pre-populate the field for new incidents. Past incidents are unaffected.
6. Select whether you would like to **Enable** or **Disable** the field. Fields can be subsequently enabled or disabled after creation. Disabled fields are not visible during an incident.
7. Click **Create**. Repeat these steps for as many fields as needed.

Edit a Custom Field
-------------------

1. Navigate to **Incidents**  **Incident Types**.
2. Click the  menu to the right of the field you would like to edit and select **Edit**.
3. Edit your preferred details and then click **Update Field**.

Disable a Custom Field
----------------------

When you disable a field, it is no longer editable on new or existing incidents. However, this will not erase values from existing incidents (they will still be visible on the incident details page). You should disable fields when you want to maintain existing data, but no longer want to use the field.

1. Navigate to **Incidents**  **Incident Types**.
2. Click the  menu to the right of the field you would like to edit and select **Edit**.
3. Under Enable Field, select **Disable** from the dropdown.
4. Edit your preferred details and then click **Update Field**.
...
1. Navigate to **Incidents**  **Incident Types**.
2. Click  to the right of the field you would like to delete and select **Delete**.
3. In the confirmation modal, type **Delete**.
...
> * URL values can have a maximum of 500 characters. Only absolute URLs are allowed, and they must use one of the following schemes: `http`, `https`, `tel`.
...
* [In the web app](#view-custom-fields-in-the-web-app)
* [In the mobile app](#view-custom-fields-in-the-mobile-app)
...
![Custom fields in the web app](https://files.readme.io/a50cc15-11b7f78-custom-fields-incident-view.png "custom-fields-incident-view.png")
...
1. Navigate to an incident's details page and click **Edit Fields** in the **Custom Fields** section.
2. In the right pane, enter your desired value(s) for each Custom Field.
3. Click **Save**.

When a responder updates a Custom Field's value, a log entry is added to the incident's timeline.

![Custom field in the incident timeline](https://files.readme.io/8a8b63c-Custom_field_in_the_incident_timeline.png)
...
![Custom fields in the mobile app](https://files.readme.io/0f76e42-custom_fields_mobile.png)
...
Please read our [Custom Field Mappings](/main/docs/advanced-servicenow-configuration#custom-field-mappings) article for more information on bi-directionally syncing PagerDuty Custom Fields with ServiceNow Incident record fields.

Set Custom Field Values with Event Orchestration
================================================

Please see our [Event Orchestration](/main/docs/event-orchestration#custom-fields) article for more information.
...
Please contact our [Sales team](https://www.pagerduty.com/contact-us/#contact-sales) if you'd like to upgrade to a plan that offers more Custom Fields.
...
* + [Configure Custom Fields](#configure-custom-fields)
    ...
    - [Disable a Custom Field](#disable-a-custom-field)
    - [Delete a Custom Field](#delete-a-custom-field)
  + [Field Types](#field-types)
  + [View Custom Fields](#view-custom-fields)
    - [View Custom Fields in the Web App](#view-custom-fields-in-the-web-app)
    - [View Custom Fields in the Mobile App](#view-custom-fields-in-the-mobile-app)
  + [Sync PagerDuty Custom Fields with ServiceNow Incident Record Fields](#sync-pagerduty-custom-fields-with-servicenow-incident-record-fields)
  + [Set Custom Field Values with Event Orchestration](#set-custom-field-values-with-event-orchestration)
  + [FAQ](#faq)
    - [What happens to active incidents if I add or remove a Custom Field?](#what-happens-to-active-incidents-if-i-add-or-remove-a-custom-field)
    - [How many Custom Fields can I create?](#how-many-custom-fields-can-i-create)
