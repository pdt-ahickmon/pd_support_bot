...
Service extensions allow you to connect PagerDuty to third-party tools such as Slack, Microsoft Teams, Jira Cloud, etc. These tools can extend PagerDuty's capabilities and help streamline your incident response and communication.
...
> 👍 Extensions with Dedicated Pages
> ---------------------------------
> 
> Some extensions have dedicated pages and the information below will not apply, for example [Slack](/main/docs/slack-integration-guide), [Microsoft Teams](/main/docs/microsoft-teams), and [Jira Cloud](/main/docs/jira-cloud). Please refer to a product’s integration guide if you find the information in this guide is not applicable.
...
> ---------------------------
> 
> Users with the following roles can manage extensions on both the [Extensions](#manage-extensions-on-the-extensions-page) and the [Service details](#manage-extensions-on-the-service-details-page) page:
> 
> * Manager [Team](/main/docs/teams) role
> * **Note**: Users with a Manager Team role and lower-level base role (e.g., Responder, Observer, or Restricted Access) can **only** manage extensions from the service details page.
> * Admin/Global Admin
> * Account Owner
> 
...
2. Select the tab **Integrations** and scroll to the section **Extensions and Add-Ons**.

Create Extensions
-----------------

1. Navigate to **Services**  **Service Directory** and select your desired.
2. Select the tab **Integrations**, scroll to the section **No extensions or add-ons found on this service**, and click **Add an Extensions**.
   1. **Note**: If an extension already exists on the service, please click **Add or manage extensions**.
3. Click **New Extension** and enter the requested information, for example:
   * **Extension Type**
   * **Name**
   * **Details**

![A screenshot of the PagerDuty web app showing where to enter extension details](https://files.readme.io/0931064-image4.png "Enter extension details")
...
1. Navigate to **Services**  **Service Directory** and select your desired service.
2. Select the tab **Integrations**, scroll to the section **Extensions and Add-Ons**, and click **Add or manage extensions**.
...
The Extensions page allows you to view and manage all of your service extensions, persistent [conference bridges](/main/docs/conference-bridge) and [add-ons](#add-ons).
...
![A screenshot of the PagerDuty web app showing how to view more extensions](https://files.readme.io/fc3f6e9-image3.png "View more extensions")
...
2. With the **Service Extensions** tab selected, click **New Extension** and enter the requested information, for example:
   * **Extension Type**
   * **Name**
   * **Service**
   * **Details**
...
* [Table of Contents](#)
* + [Manage Extensions on the Service Details Page](#manage-extensions-on-the-service-details-page)
    - [View Extensions](#view-extensions)
    - [Create Extensions](#create-extensions)
    - [Edit Extensions](#edit-extensions)
    - [Delete Extensions](#delete-extensions)
  + [Manage Extensions on the Extensions Page](#manage-extensions-on-the-extensions-page)
    - [View Extensions](#view-extensions-1)
    - [Add Extensions](#add-extensions)
    - [Update Extensions](#update-extensions)
    - [Delete Extensions](#delete-extensions-1)
