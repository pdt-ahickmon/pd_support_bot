...
Legacy Event Intelligence
=========================

Migrate to AIOps for expanded feature set

Legacy Event Intelligence was an add-on that was priced per user license and came with a limited feature set. This product is still available to existing Event Intelligence customers, but has not been available to new customers since April 11, 2023.

> 👍 PagerDuty AIOps
> -----------------
> 
> [PagerDuty AIOps](/main/docs/aiops) is the next generation of Event Intelligence. It is priced by event consumption and it has an expanded feature set. Legacy Event Intelligence users may continue using Event Intelligence, or migrate to PagerDuty AIOps.

Legacy Event Intelligence Features
==================================

Legacy Event Intelligence shares features that have been moved to PagerDuty AIOps. These features include:
...
The features above will still be maintained, but Legacy Event Intelligence users will not receive new features or updates. Updates will apply to PagerDuty AIOps only. Please contact our [Sales team](https://www.pagerduty.com/contact-us/) about migrating to PagerDuty AIOps.
...
* [Table of Contents](#)
* + [Legacy Event Intelligence Features](#legacy-event-intelligence-features)
