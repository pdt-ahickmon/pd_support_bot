...
![A screenshot of the PagerDuty web app detailing service relationships in the Service Graph](https://files.readme.io/49f804b-image6.png "image6.png")
...
> --------------
> 
> * Users with [permission to view each service](/main/docs/service-profile) in a dependency relationship will be able to see that relationship in the Service Graph. If a user does not have permission to view a service, that service and relationship will not display in the graph.
> * The Service Graph is available as soon as one or more [technical](/main/docs/services-and-integrations#create-a-new-service) or [business services](/main/docs/business-services#configure-business-services) is configured. No further configuration is necessary.
> * If you would like to configure dependencies in bulk, you can do so [via the REST API](https://developer.pagerduty.com/api-reference/b3A6Mjc0ODE5Mg-associate-service-dependencies), Terraform, or by [provisioning them from ServiceNow](/main/docs/servicenow-provisioning).

In the PagerDuty web app, navigate to **Services**  **Service Graph**. The Service Graph will display services that have at least one [dependency relationship](/main/docs/service-profile#service-dependencies-tab). Any services that do not yet have dependency relationships will be listed in the right panel under **Services without Dependencies**, which are sorted into two tabs: **Technical Services** and **Business Services**.
...
* **Service Name**
* **Team**: Only available on accounts with [Teams](/main/docs/teams), and when the view is sufficiently zoomed in.
* **Operational Status of the Service**: Operational technical services and business services will show a **green** checkmark. Impacted technical services will show a **red** exclamation mark. Impacted business services will display the most-impacting incident's [Priority](/main/docs/incident-priority).
...
![A screenshot of PagerDuty web app showing service details in the right panel](https://files.readme.io/1119dc2-image1.png "image1.png")
...
![A screenshot of the PagerDuty web app showing how a user can select a service to focus the Service Graph](https://files.readme.io/4729f6b-image4.png "image4.png")
...
![A screenshot of the PagerDuty web app showing that additional service relationships exist](https://files.readme.io/d304261-image5.png "image5.png")
...
> ---------------------------
> 
> Users with [permission to create dependency relationships between services](/main/docs/service-profile#add-or-remove-service-dependencies-via-the-web-app) are able to draw connections between nodes in the Service Graph.
...
![A screenshot of the PagerDuty web app showing draggable nodes at the top and bottom of a service card](https://files.readme.io/20629fe-image3.png "image3.png")
...
4. Draw an arrow between the services by **selecting a node and dragging it** in your desired direction to denote the dependency relationship.
...
![A screenshot of the PagerDuty web app showing how to disconnect a service dependency relationship](https://files.readme.io/410a634-image2.png "image2.png")
...
* [Business Services](/main/docs/business-services)
* [Service Profile: Service Dependencies Tab](https://support.pagerduty.com/docs/service-profile#service-dependencies-tab)

* [Table of Contents](#)
* + [View the Service Graph](#view-the-service-graph)
    - [Service Cards](#service-cards)
    - [Right Panel](#right-panel)
  + [Create Service Dependencies](#create-service-dependencies)
    - [Disconnect Dependency Relationships](#disconnect-dependency-relationships)
