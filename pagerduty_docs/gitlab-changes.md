...
**In PagerDuty**: This integration requires a [Manager base role](/main/docs/advanced-permissions#base-roles) or higher to configure.
...
* These events will be viewable as [Change Events](/main/docs/change-events) in the service’s Recent Activity timeline, on incidents associated with that service, and in a global list of all changes. They will not generate alerts, incidents or notifications.

> 📘 Change Events
> ---------------
> 
> For more information about how PagerDuty surfaces change events on services, incidents and in the [Service Directory](/main/docs/service-directory), please see [Change Events](/main/docs/change-events).
...
![Select "GitLab"](https://files.readme.io/3e8778b-image1.png "Select \"GitLab\"")
...
4. In the list of integrations, click  to the right of the GitLab integration.

![Integration details](https://files.readme.io/b27b7e1-image2.png "Integration details")
...
5. In the section **Integration URL**, click  to copy the integration URL to your clipboard. It will be in the following format: `https://events.pagerduty.com/integration/xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx/change/enqueue`. Keep this URL in a safe place for use in the [next section](#in-gitlab).

### Branch Tracking

By default, the integration tracks changes on your `main`/`master` branch. If you’d like to change which branch is tracked, or track multiple branches, you can do this in the PagerDuty web app. If you do not wish to change which branch is tracked, please skip ahead to the next section [In GitLab](#in-gitlab).
...
![Integration settings](https://files.readme.io/a4be3c4-image4.png "Integration settings")
...
3. On the right-hand side, click **Edit Integration**.
4. In the field **branch**, enter the name of the branch you’d like to track.  
...
2. Paste the **Integration URL** you generated in PagerDuty ([above](#in-pagerduty)) into the **URL** field.
...
After you’ve [added a webhook to your GitLab project](#in-gitlab), you can test the integration by creating a [merge request](https://docs.gitlab.com/ee/user/project/merge_requests/) in the project. In the PagerDuty web app, navigate to the integrated service, click its **title**, and you will see an entry in the **Recent Changes** section:

![A screenshot of the PagerDuty UI detailing an example change event](https://files.readme.io/2204577-image3.png "Example change event")
...
Not at this time, but we are interested to learn about what you would like to accomplish. Please [contact our Support team](https://www.pagerduty.com/contact-us/#contact-support) with your use case and feedback.

Is it possible to send change events from multiple GitLab branches?
-------------------------------------------------------------------

Yes, you can add any number of integrations to a single service, including multiple GitLab integrations. Please see the section [Branch Tracking](#branch-tracking) for information about customizing which branch an integration is associated with.

Are change events viewable in Slack or the mobile app?
------------------------------------------------------

Not at this time, but we would like to hear your feedback. Please [contact our Support team](https://www.pagerduty.com/contact-us/) with your feedback.
...
* [Table of Contents](#)
* + [GitLab + PagerDuty Benefits](#gitlab--pagerduty-benefits)
  ...
  + [FAQ](#faq)
    ...
    - [Is it possible to send change events from multiple GitLab branches?](#is-it-possible-to-send-change-events-from-multiple-gitlab-branches)
    - [Are change events viewable in Slack or the mobile app?](#are-change-events-viewable-in-slack-or-the-mobile-app)
