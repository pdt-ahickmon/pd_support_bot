...
The PagerDuty on-call widget allows [PagerDuty Mobile App](/main/docs/mobile-app) users to quickly view their on-call status and any upcoming shifts from their device's home screen without needing to open the app.

> 📘 Availability
> --------------
> 
> Mobile widgets are available to users on all pricing plans.

Add the On-Call Widget
======================

The on-call widget will prioritize **Always On-Call** shifts. Larger widgets will show on-call shifts with a defined end time lower in the list of shifts.
...
1. Long-press your device's home screen, tap **Edit** in the top left, and select **Add Widget**.
2. Search and select **PagerDuty** from the list of widgets.
3. Tap **Add Widget**.
4. *Optionally* resize and/or drag the widget to a new location. For users with multiple escalation policies, we recommend opting for the larger widget.
5. Tap **Done**.

![A screenshot of the iOS home screen with PagerDuty widgets](https://files.readme.io/5df31712a4865537c4e453bb008db6421504435890aad9b0722adcbf11aa7dce-ios_home_screen.png)



Add the iOS on-call widget
...
An on-call widget is also available for your lock screen.

1. Touch and hold the Lock Screen until the Customize button appears.
2. Tap **Customize**.
3. Tap **Lock Screen**, then tap  **+ Add Widgets**.
4. Tap **PagerDuty** from the list of widgets, and tap or drag the **PagerDuty** widget onto your Lock Screen.
5. Tap **Done**.

![A screenshot of the iOS Lock Screen showing the PagerDuty on-call widget](https://files.readme.io/dfc4ba09f641bb448d456a5a5b782bb348cea6b2aef4561333fbf8a2850b834a-ios_lock_screen.png)



On-call widget on the iOS lock screen
...
1. Long-press your device's home screen and select **Widgets**.
2. Search and select **PagerDuty** from the list of widgets, and tap **Add**.
   1. **Note**: If you do not see **PagerDuty** in the list of widgets, please make sure you are [logged in to the mobile app](/main/docs/log-in-to-pagerduty#log-in-via-the-web-or-mobile-app).
3. *Optionally* resize the widget vertically and horizontally to view more or fewer escalation policies.

![A screenshot of the PagerDuty Android app showing the on-call widget to the home screen](https://files.readme.io/9ef196478e8811eed6fbf667081602c771b8da302d548d4e0784c279c608e7ba-android_home_screen.png)



Add the Android on-call widget to the home screen



Interact with the On-Call Widget
================================

Tap the widget to navigate to the mobile app's [My On-Call Shifts](/main/docs/mobile-app#my-on-call-shifts-screen) screen.

> 📘 Switch Subdomains
> -------------------
> 
> To see on-call shifts from a different subdomain, you will need to switch accounts in your PagerDuty Mobile App. Please read [Switch PagerDuty Accounts in the Mobile App](/main/docs/mobile-app#switch-pagerduty-accounts-in-the-mobile-app) for more information.

Reposition the On-Call Widget
=============================

To reposition the widget, long-press it and drag-and-drop it to a new location on your device's home screen. You may also see an option to resize the widget.

Delete the On-Call Widget
=========================

To remove the widget, long-press the widget and select the option to remove it.
...
* [Table of Contents](#)
* + [Add the On-Call Widget](#add-the-on-call-widget)
    - [iOS Home Screen](#ios-home-screen)
    - [iOS Lock Screen](#ios-lock-screen)
    - [Android Home Screen](#android-home-screen)
  + [Interact with the On-Call Widget](#interact-with-the-on-call-widget)
  + [Reposition the On-Call Widget](#reposition-the-on-call-widget)
  + [Delete the On-Call Widget](#delete-the-on-call-widget)
