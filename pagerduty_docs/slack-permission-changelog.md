...
**For more detailed information on all scopes requested by the PagerDuty Slack application, [see the full listing here](/main/docs/slack-integration-guide#bot-token-scopes).**
...
Added the following **[optional](/main/docs/slack-integration-guide#optional-scopes)** bot token scopes: `channels:history`, `groups:history`, `reactions:read`, `reactions:write`.
...
![](https://files.readme.io/55388b1584780db5ff8840b1cd3bf47719fd7d04a69727d4f8bcbbc26a08f0ad-slack-optional-scopes-highlighted.png)
...
The PagerDuty Slack application now allows customers to leverage [PagerDuty Advance](/main/docs/pagerduty-advance) directly from the PagerDuty Slack app, without needing to install the separate **PagerDuty Advance** Slack app. If you are already using the **PagerDuty Advance** Slack app, you may enable these optional scopes and uninstall the **PagerDuty Advance** app.

Additionally, the PagerDuty Slack application now supports ingesting Slack data into [Jeli](/main/docs/get-started-with-jeli) for post-incident analysis. With these new scopes enabled, PagerDuty can automatically ingest the contents of your dedicated Slack channel into your Jeli Opportunity.
...
This scope is used to enable the [Add a Bookmark](https://support.pagerduty.com/actions/docs/add-a-bookmark) incident workflow action.
