...
> ------
> 
> This feature is available on Business, Enterprise for Incident Management and Digital Operations (Legacy) plans. Please contact our [Sales Team](https://www.pagerduty.com/contact-sales/) if you would like to upgrade to a plan featuring Add Responders.

> 👍 Best Practice
> ---------------
> 
> For an in-depth look at how adding Responders can improve your organization's processes, please refer to our [Incident Response](https://response.pagerduty.com/) best practice guide.

Add Responders to an Incident
=============================

You can request **individual users** or [**escalation policies**](/main/docs/add-responders#section-escalation-policy-responder-notifications) as responders, with a limit of 500 unique responders and 1000 responder requests per incident. The requested users receive a notification, allowing them to accept or decline the request.

There are two ways to add responders to an incident:

* [Manually add responders to an ongoing incident](/main/docs/add-responders#section-manually-add-responders-to-an-ongoing-incident)
* [Automatically add responders with Incident Workflows](/main/docs/add-responders#section-automatically-add-responders-with-incident-workflows)
...
2. In the field **Start typing to search across Escalation Policies and Users**, search and select the **Escalation Policy** and/or **Users**. You may *optionally* add a message or a [conference bridge](/main/docs/conference-bridge).
3. Click **Save**.
...
2. In the field **Additional Responders to Notify**, search and select the **Escalation Policies** and/or **Users**.
3. When you have entered all necessary information for the incident, click **Create Incident**.
...
1. In an open incident, tap  **More** in the lower right and select **Add Responder**.
2. Next, select the name of the responder or escalation policy you would like to add, add an *optional* message, and tap **Notify**.
...
If you find yourself frequently mobilizing the same set of responders, you can define them ahead of time in an [Incident Workflow](/main/docs/incident-workflows) to automate and accelerate the mobilization process. Then, during an incident, a user can run the appropriate play by choosing it from their list of available plays. Alternatively, a service can be configured to run an Incident Workflow when specific conditions are met.

Read more about each option:

* [Create An Incident Workflow](/main/docs/incident-workflows#create-an-incident-workflow)
* [Automatically Running an Incident Workflow When a Condition is Met](/main/docs/incident-workflows#run-an-incident-workflow-when-a-condition-is-met)

Responder Notifications
=======================

Responder notifications will ask you to accept or decline a request to join an incident. When a user is requested as a responder, they can expect to receive notifications that match their [high urgency notification rules](/main/docs/configuring-a-user-profile#configure-notification-rules).
...
* [Table of Contents](#)
* + [Add Responders to an Incident](#add-responders-to-an-incident)
    - [Manually Add Responders to an Ongoing Incident](#manually-add-responders-to-an-ongoing-incident)
    - [Automatically Add Responders With Incident Workflows](#automatically-add-responders-with-incident-workflows)
  + [Responder Notifications](#responder-notifications)
    - [Escalation Policy Responder Notifications](#escalation-policy-responder-notifications)
  + [Status of Responders](#status-of-responders)
