...
Mitigate a Jeli Incident
========================

Move Jeli incidents to the mitigated stage upon resolution | Jeli Part of PagerDuty

When a Jeli incident is resolved and you are ready to review it, you can move the incident to the **Mitigated** stage. This will create a Jeli [Opportunity](/main/docs/opportunities), and you can effortlessly send follow-up items to the incident channel.
...
1. Enter `/jeli stage` to move a Jeli incident to the mitigated stage. This will also create a Jeli [Opportunity](/main/docs/opportunities) for when you’re ready to begin your incident review.
2. Once you supply an optional reason for the stage change, you will receive a prompt allowing you to provide a new **Incident name** using all the information you've gathered during the incident response, as well as provide a new **Summary**.
3. Click **Submit**.
4. In the next modal, review the final details and then click **Update Stage**

![/jeli stage command](https://files.readme.io/9687da3-stage_mitigated.gif)
...
The new name and summary will update in the newly-created Jeli opportunity, as well as in the Slack broadcast channels. Moving an incident to the mitigated stage also means we will no longer send you status update reminders on your set intervals.
...
When an incident is moved to the mitigated stage, we send the list of follow-up items to the incident channel. You can choose to **Schedule a Reminder** on a followup and we’ll notify you again on the date and time you choose.

![Schedule a followup](https://files.readme.io/1434e5d-follow-ups.gif)
...
You can also perform the following on the followup: **Mark Done**, **Edit** to add more details, or **Schedule a Reminder** to notify someone else about the item.

> 📘 Tip
> -----
> 
> Scheduled reminders for followups will not ping to remind you if the following occur:
> 
> * Followup marked as done or ignored
> * Incident close
...
* [Table of Contents](#)
* + [Set an Incident’s Stage to Mitigated: `/jeli stage`](#set-an-incidents-stage-to-mitigated-jeli-stage)
  + [Address Followups](#address-followups)
