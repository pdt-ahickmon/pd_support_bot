...
> * Responder users with a Manager [Team role](/main/docs/advanced-permissions#team-roles) can create custom incident actions for services associated with their Team.
...
| Field | Instructions |
| --- | --- |
| **Button Label** | Enter a name for the button that will appear in PagerDuty incidents. |
| **URL Endpoint** | Enter the URL endpoint where PagerDuty will be send the HTTP POST request when a user selects the Custom Incident Action's button. |
...
| **Custom Headers** *(Optional)* | Click **Add Custom Header** and enter a **Header Name** and **Header Value**. These headers will be included on each webhook sent from this custom incident action. You may click **Add Custom Header** again to add multiple custom headers. **Note**: With V3 Webhook Subscriptions, [all header names must be unique](https://developer.pagerduty.com/docs/ZG9jOjExMDI5NTkw-v3-overview#custom-headers) . To delete a custom header, click  to the right. |

6. When you have finished configuring your custom action, click **Create Action**.

For more information about the payload you will receive through a PagerDuty webhook, please visit our [Developer Documentation](https://developer.pagerduty.com/docs/ZG9jOjQ1MTg4ODQ0-overview#webhook-payload).

![A screenshot of the PagerDuty UI showing an example Custom Incident Action during creation](https://files.readme.io/6fb4269-custom-incident-actions-new-action.png "custom-incident-actions-new-action.png")
...
![A screenshot of the PagerDuty web app showing how to execute a Custom Incident Action](https://files.readme.io/9a92b74c2ae8739f4e53c86621951c1fc012110b5d67ddb2b3586dd24847a6c9-Custom_Incident_Action.png "custom-incident-actions-incident-button.png")
...
* [Table of Contents](#)
* + [Create a Custom Incident Action](#create-a-custom-incident-action)
    - [Copy the Custom Incident Action Webhook ID](#copy-the-custom-incident-action-webhook-id)
  + [Edit a Custom Incident Action](#edit-a-custom-incident-action)
  + [Remove a Custom Incident Action](#remove-a-custom-incident-action)
  + [Execute a Custom Incident Action](#execute-a-custom-incident-action)
  + [Common Use Cases](#common-use-cases)
    - [Restart Server](#restart-server)
    - [Add Diagnostics](#add-diagnostics)
