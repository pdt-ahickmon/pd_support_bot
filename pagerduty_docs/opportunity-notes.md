...
Manage and share Jeli event notes for incident review meetings | Jeli Part of PagerDuty

In the Notes section of a Jeli opportunity, you can view event-related notes, add freeform notes and share notes with stakeholders. Use notes to ask incident response questions and prepare for interviews and learning review meetings.

You can access the Notes section by navigating to **Opportunities**  select your desired **opportunity**  select **Notes** in the left menu.

![Add a note](https://files.readme.io/abc2fa4-participant_follow_up.png)
...
Add event notes to ask broader questions and clarify what happened during response.

1. In the Jeli web app, select your desired **opportunity** and select **Events** in the left menu.
2. To the right of your desired event, click the  menu and select **Add note**.
3. Enter your note and then click **Create Note**. This note will now be available in the opportunity’s **Notes** section in the left menu.

Create Freeform Notes
---------------------

You also can add freeform notes to opportunities:

1. In the Jeli web app, select your desired **opportunity** and select **Notes** in the left menu.
2. Click **Create a Note**.
3. Enter your freeform note and then click **Create Note**.
...
2. Perform the following:  
   ...
   i. **If you are editing an [event note](#create-event-notes)**: You can select either **Notes** or **Events** in the left menu (the note will be available in both sections). Proceed to step 3.  
   
   ii. **If you are editing a [freeform note](#create-freeform-notes)**: Select **Notes** in the left menu. Proceed to step 3.
3. You may search to locate the note. Click the  menu to the right of the note you want to edit and select **Edit note**.
4. Edit your note and then click **Done** to save.
...
2. Perform the following:  
   ...
   i. **If you are deleting an [event note](#create-event-notes)**: You can select either **Notes** or **Events** in the left menu (the note will be available in both sections). Proceed to step 3.  
   
   ii. **If you are deleting a [freeform note](#create-freeform-notes)**: Select **Notes** in the left menu. Proceed to step 3.
3. You may search to locate the note. Click the  menu to the right of the note you want to delete and select **Delete note**.
4. A confirmation modal will appear. Click **Delete** to delete the note.

View and Search Notes
=====================

Select **Notes** in an opportunity's left menu panel to see a list of notes created in the Events section, and/or freeform notes created in the Notes section. Enter a **search term** into the **Search** bar to find a specific note.

Share Notes
===========

You can share the link to your opportunity’s Notes page with others that you'd like to interview, so they know your questions ahead of time. You can also share this link with incident responders who you might call on for context during the learning review.

1. In the Jeli web app, navigate to your desired **opportunity** and select **Notes** in the left menu.
2. In the **Search** bar, enter the **name** of the person you’d like to share the link with.
3. This will pull up all the notes where their name appears.
4. **Copy the URL** to share a direct link with them.
...
* + [Create Notes](#create-notes)
    ...
    - [Create Freeform Notes](#create-freeform-notes)
    - [Edit Notes](#edit-notes)
    - [Delete Notes](#delete-notes)
  + [View and Search Notes](#view-and-search-notes)
