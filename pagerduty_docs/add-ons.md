...
Add-ons enhance your PagerDuty experience with apps hosted outside of the core PagerDuty product, but are still accessible within the PagerDuty web app. For example, you can add your own scripts, web apps, and dashboards to your PagerDuty environment. Add-ons can interact with our [APIs](https://developer.pagerduty.com/docs/ZG9jOjQ2NDA2-introduction), which means you can customize the PagerDuty web app to provide additional functionality that is not currently available.

> 🚧 Required User Permissions
> ---------------------------
> 
> The Account Owner and Admin users can manage Add-ons. If you're not sure what role you have, or if you need your permissions adjusted, visit our sections on [Check Your User Role](/main/docs/user-roles#check-your-user-role) or [Edit User Roles](/main/docs/users#edit-user-roles).

View Add-ons
============

Add-ons may appear in two different places, depending on which option you select during [installation](#install-an-add-on):

* **Its own page**: This option will add a link under **Your Integrations** when you hover over **Integrations** in the web app.

![A screenshot of the PagerDuty UI indicating where to find an add-on in the Integrations menu](https://files.readme.io/85745bb-image1.png "View add-ons")
...
* **Incidents on these services**: This option will embed your add-on on the incidents detail page of any services you select during [configuration](#install-an-add-on).

![A screenshot of the PagerDuty UI indicating where to find an add-on on an incident's details page](https://files.readme.io/1c014e9-image2.png "Custom dashboard")
...
> ------------------------------
> 
> You will need to set the following response headers in order for the server that hosts add-ons to load the document in a frame:
> 
