...
1. Navigate to **More**   in the upper right.
2. Tap **Automatic Contact Card Management**. Once updated, you will be able to see the date and time it was updated for future reference.
   1. **Note**: You may be prompted to enable access to your contacts in your device’s settings in order to use this feature.

Update the vCard via Web Download
---------------------------------

If you do not have the PagerDuty mobile app, you may also download the vCard using the link below:

  
[Download the PagerDuty vCard](https://s3.amazonaws.com/pdpartner/PagerDuty+Outgoing+Numbers.vcf)  
...
If you are using the web download, this will not automatically update. Please update periodically, or install the mobile app for [automatic updates](#automatically-update-vcard-in-the-pagerduty-mobile-app).

> 📘 SMS Short Codes
> -----------------
> 
> If you're experiencing issues receiving SMS messages from short codes, your phone may be blocking short code messages, or your carrier may need to [enable short code messaging](/main/docs/notification-troubleshooting#short-code-messaging-restrictions) for you.
...
* [Table of Contents](#)
* + [PagerDuty vCard](#pagerduty-vcard)
    - [Automatically Update vCard in the PagerDuty Mobile App](#automatically-update-vcard-in-the-pagerduty-mobile-app)
    - [Update the vCard via Web Download](#update-the-vcard-via-web-download)
