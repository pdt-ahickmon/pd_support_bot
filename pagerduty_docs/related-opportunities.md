...
Jeli's Related Opportunities feature surfaces interconnected opportunities as your system changes over time. That may include a specific service's impact as a contributing factor to incidents, technologies that share common participants, or an indication of your team’s ability to respond during off hours alerts.
...
You can view related opportunities in the Jeli web app by navigating to the **Overview** tab and scrolling to the **Related Opportunities** section.

![Opportunity overview](https://files.readme.io/b1f4e34-related_opportunities.png)
...
* The list of related opportunities will update as users add or remove Technologies or Services [Opportunity Tags](/main/docs/opportunity-tags) on other opportunities across the platform.
* A sparkle icon (i.e., ✨) denotes an opportunity that Jeli automatically added. Auto-suggested opportunities may change over time if relationships become more evident. Opportunities without a sparkle icon were manually added.

Add Related Opportunities
=========================

Jeli will display up to three related opportunities. You can manually add more, if needed.

To add opportunities to the Related Opportunities list:

1. In the Jeli web app, select **Opportunities** from the left navigation and click your preferred opportunity from the list.
2. With the **Overview** tab selected, scroll to the section **Related Opportunities** and click **Add**.
3. Enter a keyword to search within the list of opportunities.

![](https://files.readme.io/7cb08b6-keyword.png)

4. Click **Add** to the right of the opportunity you'd like to associate with the current opportunity.

Remove Related Opportunities
============================

To remove opportunities from the Related Opportunities list:

1. In the Jeli web app, select **Opportunities** from the left navigation and click your preferred opportunity from the list.
2. With the **Overview** tab selected, scroll to the section **Related Opportunities** and click **remove** next to the opportunity you’d like to remove.
3. When prompted, click **Remove** again to confirm.

![Remove related opportunity](https://files.readme.io/122ba5a-confirm.png)



Remove related opportunity



By removing the opportunity, it will no longer appear on either opportunities' details page, and Jeli will not suggest it as a related opportunity in the future. If you wish to relate the opportunities again, you can [manually add](#add-related-opportunities) the removed opportunity.

Learning Algorithm Behavior
===========================

When you add and remove [Opportunity Tags](/main/docs/opportunity-tags), Jeli recalculates the relationship between opportunities. With that in mind, you may notice that related opportunities change after applying opportunity tags. Since Jeli is designed as a learning system, the more information you add, the more insights it can surface.
...
* [Table of Contents](#)
* + [View Related Opportunities](#view-related-opportunities)
  + [Add Related Opportunities](#add-related-opportunities)
  + [Remove Related Opportunities](#remove-related-opportunities)
  + [Learning Algorithm Behavior](#learning-algorithm-behavior)
