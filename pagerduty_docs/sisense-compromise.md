...
If you have any questions or concerns, please contact us at [SecurityComplianceGRC@PagerDuty.com](mailto:SecurityComplianceGRC@PagerDuty.com.). We are here to support you and address any issues that may arise.
...
* [Table of Contents](#)
* + [Does PagerDuty use Sisense?](#does-pagerduty-use-sisense)
  + [Has PagerDuty detected or experienced any unauthorized activity due to the breach?](#has-pagerduty-detected-or-experienced-any-unauthorized-activity-due-to-the-breach)
  + [What steps has PagerDuty taken to address this potential exposure](#what-steps-has-pagerduty-taken-to-address-this-potential-exposure)
  + [Does PagerDuty use any third parties in the provision of services to PD Customers?](#does-pagerduty-use-any-third-parties-in-the-provision-of-services-to-pd-customers)
  + [Has PagerDuty reached out to these third parties (4th parties to PagerDuty customers) to understand whether they have experienced any impact?](#has-pagerduty-reached-out-to-these-third-parties-4th-parties-to-pagerduty-customers-to-understand-whether-they-have-experienced-any-impact)
