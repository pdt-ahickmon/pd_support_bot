...
Monitor business services' status directly from your home screen

View Status Dashboard on the Home Screen
========================================

Users can view [Internal Status Pages](/main/docs/internal-status-page) in a widget on the [Mobile Home Screen](/main/docs/mobile-home-screen). The widget displays up to three impacted [business services](/main/docs/business-services). Tap a business service's name to view more details. If there are more than three disrupted services, tap **View [X] Disrupted Services** to navigate to the [Mobile Status Dashboard](/main/docs/mobile-status-dashboard), where you can view the complete list of disrupted services.

![A screenshot of the mobile app indicating how to view all disrupted business services](https://files.readme.io/63c4baf3b49fb0f11ee7a842af2783c1ecf30dac0ef5ae9001cbf5cbe85ba3c3-ios_home_screen_status_dashboard.png)
...
![A screenshot of the mobile app indicating that all business services are operational](https://files.readme.io/6fc6c47-all_business_services_operational.png)
...
> -----------------------------
> 
> You'll need to configure business services before the Status Dashboard widget will display any information. If you have not yet set up business services, you'll see a message **Business Services are not configured**.
> 
> Please read [Business Services](/main/docs/business-services) for more information about configuring business services.

Change the Default Status Dashboard
-----------------------------------

The home screen's Status Dashboard widget displays the **Business Status Summary** dashboard by default. You can change which dashboard the widget displays by selecting a different dashboard in the mobile app. Please read [View Mobile Status Dashboard](/main/docs/mobile-status-dashboard#view-mobile-status-dashboard) for more information.

Subscribe to a Business Service
-------------------------------

Tap **Subscribe** next to a business service to receive a notification for future [status updates](/main/docs/communicate-with-stakeholders#status-updates).

![A screenshot of the mobile app indicating how to subscribe to an impacted business service](https://files.readme.io/69b6e94cf51dbd4e81f1d4432fb293432706ff4839d664ad6e0c8bd3beca7882-ios_subscribe_to_a_business_service.png)
...
You can remove the status dashboard the home screen:

iOS
---

1. Navigate to **Home**  **Edit**.
2. Tap  next to **Status Dashboard**.
3. Tap **Save**.

Android
-------

1. Navigate to **Home** and tap .
2. Tap  next to **Status Dashboard**.
3. Tap **Save**.
...
* [Table of Contents](#)
* + [View Status Dashboard on the Home Screen](#view-status-dashboard-on-the-home-screen)
    - [Change the Default Status Dashboard](#change-the-default-status-dashboard)
    - [Subscribe to a Business Service](#subscribe-to-a-business-service)
  + [Remove Status Dashboard from the Home Screen](#remove-status-dashboard-from-the-home-screen)
    - [iOS](#ios)
    - [Android](#android)
