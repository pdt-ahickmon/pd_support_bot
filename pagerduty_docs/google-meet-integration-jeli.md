...
Google Meet + Jeli Benefits
===========================

* Automatically start a Google Meet bridge when opening a Jeli Slack app incident.
* Instantly create or access Google Meet bridges during incidents with simple commands.
* Manage and control the Google Meet integration within Jeli.
...
**Admin** users can manage integrations in Jeli. To add someone as an admin, visit **Settings**  **Users** in the Jeli web app.

How it Works
============

* Users can instantly start a Google Meet bridge or retrieve the link to an existing bridge.
* This ensures seamless, efficient communication during incident management.
...
> --------------------------
> 
> We recommend using a Google service account when configuring the Google Meet integration. If an individual user sets up the Google Meet integration and then leaves your company, the integration may no longer work as expected. Please reach out your internal IT team to request or set up a service account.

In Jeli
-------

1. In the Jeli web app, navigate to **Settings**  **Integrations**  **Google Meet**.
2. Click **Sign in with Google**.
3. Select a Google account. **Note**: If you have a service account, select it here.
4. Review the requested permissions and click **Continue** to complete the installation.

![A screenshot indicating how to authorize the Google Meet integration](https://files.readme.io/7234322-jeli-google-meet-permissions.png)



Authorize the Google Meet integration



Google Meet | Jeli Integration User Guide
=========================================

Add a Google Meet Bridge to a New Jeli Incident
-----------------------------------------------

With the integration [configured](#integration-walkthrough), click **Use integrations** and select the option to **Start a Google Meet bridge for this incident** when [opening a Jeli incident](/main/docs/jeli-slackbot-commands#open-a-new-incident-jeli-open) (i.e., `/jeli open`).

![A screenshot of the Slack UI indicating how to add a Google Meet bridge when opening a Jeli incident](https://files.readme.io/2ad58c4-jeli-google-meet-start-bridge.png)



Add a Google Meet bridge when opening a Jeli incident



Add a Google Meet Bridge to an Existing Jeli Incident
-----------------------------------------------------

Run `/jeli meet` in a Jeli incident's Slack channel to add a Google Meet bridge, if one does not exist. This command will show the link to the Google Meet bridge if one already exists.

Uninstall the Google Meet | Jeli Integration
============================================

1. In the Jeli web app, navigate to **Settings**  **Integrations** and select **Edit configuration** in the Google Meet card.
2. Click **Disconnect**.
3. In the confirmation modal, click **Disconnect**.

![A screenshot of the Jeli web app UI indicating how to disconnect Google Meet](https://files.readme.io/cc944f6-disconnect_Google_Meet.png)
...
* [Table of Contents](#)
* + [Google Meet + Jeli Benefits](#google-meet--jeli-benefits)
  + [Requirements](#requirements)
    - [To Configure the Integration](#to-configure-the-integration)
  + [How it Works](#how-it-works)
  + [Integration Walkthrough](#integration-walkthrough)
    - [In Jeli](#in-jeli)
  + [Google Meet | Jeli Integration User Guide](#google-meet--jeli-integration-user-guide)
    - [Add a Google Meet Bridge to a New Jeli Incident](#add-a-google-meet-bridge-to-a-new-jeli-incident)
    - [Add a Google Meet Bridge to an Existing Jeli Incident](#add-a-google-meet-bridge-to-an-existing-jeli-incident)
  + [Uninstall the Google Meet | Jeli Integration](#uninstall-the-google-meet--jeli-integration)
