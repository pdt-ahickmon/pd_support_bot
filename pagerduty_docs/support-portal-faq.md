...
PagerDuty uses Salesforce's Service Cloud ticketing system to communicate with customers. The following address customers’ most common issues and concerns about platform:
...
1. Navigate to the [support portal](https://tickets.pagerduty.com/s/).
2. Click **Log in** in the top-right.
3. Click **Not a member?**
4. After reading the prompt and gathering your [account's subdomain](/main/docs/account-subdomains), click **Next**.
...
Premium support emails and messages sent to [support@pagerduty.com](mailto:support@pagerduty.com) have been automatically routed to the current system.

How can I view cases that I have submitted?
===========================================

To view your submitted cases, please [create an account in the support portal](/main/docs/support-portal-faq#how-do-i-create-an-account-in-the-support-portal). After logging in, you'll be able to see your emails and comments in the **Messages** tab.

How can I contact Support via chat?
===================================

Chat is available to Premium Support customers, who can access live chat by logging into the [support portal](https://tickets.pagerduty.com/s/).

How can I view a ticket that someone else at my organization submitted?
=======================================================================

We are in the process of building out the required permissions to allow account-owner-designated users to view all of the support cases for your organization in the [support portal](https://tickets.pagerduty.com/s/).
...
* [Table of Contents](#)
* + [How do I create an account in the support portal?](#how-do-i-create-an-account-in-the-support-portal)
  + [Was my email request received?](#was-my-email-request-received)
  + [How can I view cases that I have submitted?](#how-can-i-view-cases-that-i-have-submitted)
  + [How can I contact Support via chat?](#how-can-i-contact-support-via-chat)
  + [How can I view a ticket that someone else at my organization submitted?](#how-can-i-view-a-ticket-that-someone-else-at-my-organization-submitted)
