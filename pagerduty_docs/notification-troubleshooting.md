...
* Have you downloaded PagerDuty’s [vCard](/main/docs/notification-phone-numbers#pagerduty-vcard)?
* Does the issue occur after restarting your mobile device?

Confirm the Expected Behavior
=============================

There are some scenarios where you may expect to receive a notification, but the criteria for triggering a notification were not met. When this happens, it is expected behavior that you will not receive notifications. Please read [Expected Notification Behavior](/main/docs/expected-notification-behavior) for more information.
...
* + [Pre-Checks](#pre-checks)
  + [Confirm the Expected Behavior](#confirm-the-expected-behavior)
