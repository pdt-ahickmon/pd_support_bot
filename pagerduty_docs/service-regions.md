...
PagerDuty service regions allow customers to choose the geographic region of the PagerDuty data centers that host their account. When signing up for your account, you can choose one of the following service regions:
...
* Data contained within Global User Profiles.

If you choose to install an integration into your PagerDuty account, that data may also be stored outside of your chosen service region. It is your responsibility to review any integration you choose to and determine if it meets your requirements.
...
Each service region has its own login URL:

| Service Region | Login URL |
| --- | --- |
| US | <https://app.pagerduty.com/> |
| EU | <https://app.eu.pagerduty.com/> |
...
| Service Region | Events API | REST API |
| --- | --- | --- |
| US | <https://events.pagerduty.com> | <https://api.pagerduty.com> |
| EU | <https://events.eu.pagerduty.com> | <https://api.eu.pagerduty.com> |

> 🚧 Forwarding Support for EU-Bound API Requests
> ----------------------------------------------
> 
> PagerDuty can forward both REST API and Events API requests from the US service region to the EU service region when an EU integration or API key is detected. We recommend, however, sending API requests directly to the dedicated EU service region URLs above whenever possible, which improves response times and reliability.

Hosting Locations
=================

Depending on your service region, PagerDuty could be running from any of the following data centers at any point in time:

| Service Region | Data Centers |
| --- | --- |
| US | - AWS US West (Northern California)- AWS US West (Oregon)- AWS US East (Ohio) |
| EU | - AWS EU Central (Frankfurt)- AWS EU West (Ireland) |
...
| Service Region | Web Address |
| --- | --- |
| US | `your-subdomain.pagerduty.com` |
| EU | `your-subdomain.eu.pagerduty.com` |
...
Can I migrate from one service region to another?
-------------------------------------------------

You have the option to select your service region (i.e., US or EU) when signing up for PagerDuty. This is not considered a configurable setting. PagerDuty's [Professional Services](https://www.pagerduty.com/services/) may be able to migrate your account to a different service region, however there is typically a fee associated with this process. Please reach out to your Account Executive to discuss options.

Alternatively, you can [create a new PagerDuty account](https://www.pagerduty.com/sign-up/) in your preferred service region, however you will need to rebuild any services, schedules, user accounts, etc., and historical incident data will not carry over.
...
* + [Login URLs](#login-urls)
  + [API Access URLs](#api-access-urls)
  + [Hosting Locations](#hosting-locations)
  + [FAQ](#faq)
    - [How do I know my account's service region?](#how-do-i-know-my-accounts-service-region)
    - [Can my account be split across multiple service regions?](#can-my-account-be-split-across-multiple-service-regions)
    - [Can I migrate from one service region to another?](#can-i-migrate-from-one-service-region-to-another)
