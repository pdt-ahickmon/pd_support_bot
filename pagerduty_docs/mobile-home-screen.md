...
You can navigate to the Home screen in the mobile app by tapping **Home** in the app's navigation bar:

* [Status Dashboard Widget](#status-dashboard-widget)
* [My Open Incidents](#my-open-incidents)
* [On-Call Shifts](#on-call-shifts)
* [Analytics on Mobile](#analytics-on-mobile)
* [Recently Impacted Technical Service](#recently-impacted-technical-service)

Status Dashboard Widget
=======================

The Home screen displays a condensed view of the [Mobile Status Dashboard](/main/docs/mobile-status-dashboard), and gives you an overview of your account's incident-impacted business services. Please read [Home Screen Status Dashboard](/main/docs/home-screen-status-dashboard) for more information.

My Open Incidents
=================

The **My Open Incidents** section displays incidents that are assigned to you, indicates the total number in the top-left, and provides an overview of your three most-recent, open incidents. Tap an incident’s row to navigate to its [details page](/main/docs/mobile-app#incident-details-and-other-actions), where you can find more information about the incident, and acknowledge or resolve it.

Tap **New Incident** to [trigger an incident](/main/docs/mobile-app#trigger-an-incident).

If you have more than three incidents, tap **Show More** to expand the list. The expanded list will display up to 10 incidents, and you can tap **View All Open Incidents** to view all open incidents on the [Open Incidents](/main/docs/mobile-app#open-incidents-screen) screen.

**Note**: The [Open Incidents](/main/docs/mobile-app#open-incidents-screen) screen will remember which tab filter you most recently selected (**Mine**, **My Teams** or **All**), which reduces the number of taps needed to display relevant incidents.

![A screenshot of the iOS mobile app detailing the My Open Incidents section](https://files.readme.io/abd7c96937372cc3d0d500a2bf6ad7ae1cf8fe17e844f4b1ca901895c90e6adf-my_open_incidents.jpeg "My Open Incidents")
...
![A screenshot of the PagerDuty mobile app displaying an example user's on-call shifts on the mobile home screen](https://files.readme.io/6ad4b00-image2.png "On-call shifts")
...
Tap **View All Shifts** to go to the [My On-Call Shifts](/main/docs/mobile-app#my-on-call-shifts-screen) screen for a detailed overview of all your on-call responsibilities.
...
> --------------
> 
> Analytics on Mobile is available on the following pricing plans: Professional, Business, Digital Operations (legacy) and Enterprise for Incident Management.  
> 
> Please contact our [Sales team](https://www.pagerduty.com/contact-us/#contact-sales) to upgrade to a plan with this feature.

You can see an analytics overview on the Home Screen for the [Teams](/main/docs/teams) you are a part of. If your account does not have Teams, you'll see analytics for your entire organization.

The Analytics section displays information from the previous month for the following metrics:

* **High Urgency Incidents**
* **MTTA** (Mean time to acknowledge)
* **MTTR** (Mean time to resolve)

Change trends are compared to metrics from the 30 days prior to the displayed date range.

![A screenshot of the PagerDuty mobile app showing Team analytics on the Mobile Home Screen](https://files.readme.io/326582e-analytics_on_mobile.png)



Analytics on the Mobile Home Screen
...
This section displays the most recently impacted technical service associated with your [Teams](/main/docs/teams). If your account does not have the Teams feature, it will display the most recently impacted technical service in your PagerDuty account.

For an overview of all services in your PagerDuty account, tap **View Services** to go to the [Service Directory](/main/docs/service-directory).
...
> -------------------
> 
> If you have more than one PagerDuty account, you can save different customizations for each account.

> 📘 Device Information
> --------------------
> 
> Instructions and screenshots below are for the following devices. Depending on your device and operating system, information may vary slightly:
> 
> * **iOS**: iPhone 16 Pro, iOS 18.1
> * **Android**: Pixel 9 Pro, Android 15.0

iOS
---

1. Tap **Home**  **Edit**.
2. Tap  next to a card to add it to your Home Screen. Tap  to remove a card from your Home Screen.
   1. **Note**: You must have at least one card on your Home Screen.
3. *Optional*: Tap and drag  to reorder the cards.
4. Tap **Save**.

![A screenshot of the iOS PagerDuty mobile app showing how to edit the Mobile Home Screen](https://files.readme.io/86a68c48356f0d102cd2c46d635d4783240e26daafe6a4ce7afe450ebd196fc9-ios_edit_home_screen.png)
...
![A screenshot of the Android PagerDuty mobile app showing how to edit the Mobile Home Screen](https://files.readme.io/c4b9578c01bfdb02eaa4e2aa2fc602904c41374bdcdb0c223711b60c8a847098-android_edit_mobile_home_screen.png)
...
* + [Status Dashboard Widget](#status-dashboard-widget)
  ...
  + [Analytics On Mobile](#analytics-on-mobile)
  + [Recently Impacted Technical Service](#recently-impacted-technical-service)
  + [Customize Your Home Screen](#customize-your-home-screen)
    - [iOS](#ios)
    - [Android](#android)
