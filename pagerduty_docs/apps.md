...
Users are presented with a prompt when authorizing an app with OAuth 2.0 functionality. This prompt will display the name of the app, your [service region](/main/docs/service-regions) and user ID, and a list of the permissions requested by the app.

![Authorize app access](https://files.readme.io/121cfd89758780524292d88d4161b9b3d87eabe64e14e13bc7f2086f0b9176d2-authorize-oauth-app.png)
...
* **OAuth2**: Revoke application access from the [profile page](/main/docs/user-profile#revoke-application-access) of the user who added the app.
* **Events Integrations**: [Delete the integration](/main/docs/services-and-integrations#section-delete-an-integration-from-a-service) from the service.
* **Webhooks**: [Delete the extension](/main/docs/extensions-add-ons#section-managing-extensions-on-the-service-details-page) from the service.
...
* [Table of Contents](#)
* + [Add Apps](#add-apps)
    - [Authorize OAuth 2.0 Apps](#authorize-oauth-20-apps)
