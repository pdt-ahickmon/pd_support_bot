...
* Create new Statuspage updates using the [Jeli Slackbot](/main/docs/slack-integration-jeli).
...
Admin permissions are required to manage Jeli Integrations. To add someone as an admin, visit [User Access Management Settings](https://app.jeli.io/settings/users) in the Jeli web app.
...
* Via the [Jeli Slackbot](/main/docs/slack-integration-jeli), users interact with the [Statuspage API](https://developer.statuspage.io/) to create Statuspage incidents.
...
2. Follow Atlassian's documentation to [create an API key](https://support.atlassian.com/statuspage/docs/create-and-manage-api-keys/#Create-API-keys). Keep this token in a safe place, as it is needed for a later step.
...
![A screenshot of the Jeli UI prompting the user to enter a Statuspage Page ID and API key](https://files.readme.io/c3a7611-jeli-statuspage-configuration.png)
...
After [configuring the integration](#integration-walkthrough), enter the command `/jeli statuspage` in Slack to create a Statuspage incident. Enter the following:
...
When you run the command `/jeli statuspage` in Slack, fields will be populated with information from your Jeli incident. Please see [Statuspage documentation](https://support.atlassian.com/statuspage/docs/create-an-incident/) for more information about each field.

![A screenshot of the Slack UI detailing how to create a Statuspage incident](https://files.readme.io/e0120dc-update_statuspage.png)
...
> 
> ![A screenshot of the Slack UI confirming that a Statuspage incident was created](https://files.readme.io/28cb1df-jeli_notification.png)
> 
> 
> 
...
> 
> ![A screenshot of Statuspage detailing an incident](https://files.readme.io/4782ab1-statuspage.png)
> 
> 
> 
> Statuspage incident
...
You may also *optionally* specify which components on your Statuspage you would like to mark as affected by this incident. For each component, you can set the [component status](https://support.atlassian.com/statuspage/docs/what-is-a-component/):
...
![A screenshot detailing affected components](https://files.readme.io/e2ef598-affected_components.png)
...
![A screenshot of the Jeli web app detailing how to disconnect the Statuspage integration](https://files.readme.io/18644dc-jeli-statuspage-disconnect.png)
...
* [Table of Contents](#)
* + [Statuspage + Jeli Benefits](#statuspage--jeli-benefits)
  + [Requirements](#requirements)
    - [To Configure the Integration](#to-configure-the-integration)
  + [How it Works](#how-it-works)
  + [Integration Walkthrough](#integration-walkthrough)
    - [In Statuspage](#in-statuspage-1)
    - [In Jeli](#in-jeli-1)
  + [Statuspage | Jeli Integration User Guide](#statuspage--jeli-integration-user-guide)
    - [Create a Statuspage Incident](#create-a-statuspage-incident)
    - [Update a Statuspage Incident](#update-a-statuspage-incident)
  + [Uninstall the Statuspage | Jeli Integration](#uninstall-the-statuspage--jeli-integration)
  + [FAQ](#faq)
    - [Can I manage Statuspage incident that were created outside this integration?](#can-i-manage-statuspage-incident-that-were-created-outside-this-integration)
