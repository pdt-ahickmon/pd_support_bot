...
Phone Notification Disclosures
==============================

Users who use phone services certify and acknowledge the following:

* They are the subscriber or customary authorized user of the specified phone number.
* They have the authority to consent to receiving phone calls at the specified phone number.
...
* Call rates and other connection charges may apply.
...
* PagerDuty relies on service providers, and ultimately, underlying common carriers, to deliver phone calls. Notifications may be delayed or blocked based on the applicable terms and policies of these service providers or carriers.
* Carriers are not liable for delayed or unconnected calls.
* For all questions about these services, you can [contact PagerDuty Support](https://www.pagerduty.com/contact-us/).
