...
* Nobl9 uses the webhook alert method to send SLO alerts to the [Jeli API](/main/docs/jeli-api).
...
4. Store the access token in a safe place for use in the [next section](#in-nobl9) .
   1. **Note**: The access token will only be visible once.

In Nobl9
--------

1. Navigate to **Integrations**and select the **Alert Methods** tab.
2. Click  to add an alert method and select **Webhook**.

![Image of Nobl9 user interface](https://files.readme.io/5def344-jeli-nobl9-webhook-alert-method.png)
...
3. Configure the webhook:
   ...
   7. **Notification Details**: Select **Custom** and use the payload below as a reference to configure your own [Jeli API](/main/docs/jeli-api) call:
      1. JSON
         ```
         {
           ...
           "email_of_incident_opener": "peter.venkman@jeli-sandbox-user.com",
         ...
         ```
4. Click **Add Alert Method**.

Nobl9 | Jeli Integration User Guide
===================================

You can now link the `open-jeli-incident` alert method to an alert policy so that a Jeli incident opens when an SLO alerts.​ Please see Nobl9's [Alerting](https://docs.nobl9.com/Alerting/)documentation for more information.
...
* [Table of Contents](#)
* + [Nobl9 + Jeli Benefits](#nobl9--jeli-benefits)
  + [Requirements](#requirements)
  + [How it Works](#how-it-works)
  + [Integration Walkthrough](#integration-walkthrough)
    - [In Jeli](#in-jeli)
    - [In Nobl9](#in-nobl9)
  + [Nobl9 | Jeli Integration User Guide](#nobl9--jeli-integration-user-guide)
